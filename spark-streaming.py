...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "/home/nguyenthung/Desktop/Realtime Voting System/resources/postgresql-42.7.3.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/nguyenthung/Desktop/Realtime Voting System/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/nguyenthung/Desktop/Realtime Voting System/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
